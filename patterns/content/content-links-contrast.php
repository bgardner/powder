...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color" style="min-height:100vh;margin-top:0px;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<div class="wp-block-group" style="padding-right:30px;padding-left:30px">
		...
		<div class="wp-block-buttons">
			<!-- wp:button {"width":100,"className":"is-style-fill-light"} -->
			<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-fill-light"><a class="wp-block-button__link wp-element-button" href="#"><?php echo esc_html__( 'Visit My Website', 'powder' ); ?></a></div>
			<!-- /wp:button -->
			<!-- wp:button {"width":100,"className":"is-style-fill-light"} -->
			<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-fill-light"><a class="wp-block-button__link wp-element-button" href="#"><?php echo esc_html__( 'Shop My Store', 'powder' ); ?></a></div>
			<!-- /wp:button -->
			<!-- wp:button {"width":100,"className":"is-style-fill-light"} -->
			<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-fill-light"><a class="wp-block-button__link wp-element-button" href="#"><?php echo esc_html__( 'View My Services', 'powder' ); ?></a></div>
			<!-- /wp:button -->
			<!-- wp:button {"width":100,"className":"is-style-fill-light"} -->
			<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-fill-light"><a class="wp-block-button__link wp-element-button" href="#"><?php echo esc_html__( 'Read My Journal', 'powder' ); ?></a></div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
