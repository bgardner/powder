 ...
 * Slug: powder/gallery-single-multi-grid
 * Categories: powder-gallery
 */
?>
<!-- wp:group {"metadata":{"name":"Single, Multi-Grid"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large","left":"30px","right":"30px"},"margin":{"top":"0"}}},"layout":{"type":"constrained"}} -->
