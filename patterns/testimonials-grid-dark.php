 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Testimonials"},"align":"full","className":"is-style-section-2","style":{"spacing":{"margin":{"top":"0"},"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}}},"layout":{"type":"constrained"}} -->
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-group">
				...
				<figure class="wp-block-image aligncenter size-full is-resized is-style-rounded"><img src="https://powderwp.com/studio/wp-content/themes/powder-studio/assets/images/sample-avatar-light.svg" alt="Sample avatar" style="object-fit:cover;width:40px;height:40px"/></figure>
				<!-- /wp:image -->
				<!-- wp:paragraph {"fontSize":"small"} -->
