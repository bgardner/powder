			...
			<div class="wp-block-group is-style-section-4" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)"><
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group" style="line-height:1">
						<!-- wp:image {"width":"20px","height":"20px","scale":"cover","sizeSlug":"large","linkDestination":"none","className":"is-style-display-block","style":{"color":{"duotone":"var:preset|duotone|primary-and-white"}}} -->
						<figure class="wp-block-image size-large is-resized is-style-display-block"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/icons/icon-circle-check-dark.svg'; ?>" alt="Circle check dark icon" style="object-fit:cover;width:20px;height:20px"/></figure>
						<!-- /wp:image -->
					...
					<div class="wp-block-group" style="line-height:1">
						<!-- wp:image {"width":"20px","height":"20px","scale":"cover","sizeSlug":"large","linkDestination":"none","className":"is-style-display-block","style":{"color":{"duotone":"var:preset|duotone|primary-and-white"}}} -->
						<figure class="wp-block-image size-large is-resized is-style-display-block"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/icons/icon-circle-x-dark.svg'; ?>" alt="Circle x dark icon" style="object-fit:cover;width:20px;height:20px"/></figure>
						<!-- /wp:image -->
						<!-- wp:paragraph {"fontSize":"small"} -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group is-style-section-4" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)"><
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group" style="line-height:1">
						<!-- wp:image {"width":"20px","height":"20px","scale":"cover","sizeSlug":"large","linkDestination":"none","className":"is-style-display-block","style":{"color":{"duotone":"var:preset|duotone|primary-and-white"}}} -->
						<figure class="wp-block-image size-large is-resized is-style-display-block"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/icons/icon-circle-check-dark.svg'; ?>" alt="Circle check light icon" style="object-fit:cover;width:20px;height:20px"/></figure>
						<!-- /wp:image -->
						<!-- wp:paragraph {"fontSize":"small"} -->
						<p class="has-small-font-size"><?php echo esc_html__( 'Powder theme', 'powder' ); ?></p>
						<!-- /wp:paragraph -->
