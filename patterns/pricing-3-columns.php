 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Pricing"},"align":"full","className":"is-style-section-1","style":{"spacing":{"margin":{"top":"0"},"blockGap":"var:preset|spacing|60","padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull is-style-section-1" style="margin-top:0;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			<!-- wp:group {"className":"is-style-section-4","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","right":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|60"}}},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group is-style-section-4" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)"><
				<!-- wp:group {"style":{"spacing":{"blockGap":"10px"}},"layout":{"type":"constrained"}} -->
				<div class="wp-block-group">
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group" style="line-height:1">
						<!-- wp:image {"width":"20px","height":"20px","scale":"cover","sizeSlug":"large","linkDestination":"none","className":"is-style-display-block is-style-filter-invert"} -->
						<figure class="wp-block-image size-large is-resized is-style-display-block is-style-filter-invert"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/icons/icon-circle-check-dark.svg'; ?>" alt="Circle check dark icon" style="object-fit:cover;width:20px;height:20px"/></figure>
						<!-- /wp:image -->
					...
					<div class="wp-block-group" style="line-height:1">
						<!-- wp:image {"width":"20px","height":"20px","scale":"cover","sizeSlug":"large","linkDestination":"none","className":"is-style-display-block is-style-filter-invert"} -->
						<figure class="wp-block-image size-large is-resized is-style-display-block is-style-filter-invert"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/icons/icon-circle-x-dark.svg'; ?>" alt="Circle x dark icon" style="object-fit:cover;width:20px;height:20px"/></figure>
						<!-- /wp:image -->
						<!-- wp:paragraph {"fontSize":"small"} -->
		...
		<!-- wp:column {"width":""} -->
		<div class="wp-block-column">
			<!-- wp:group {"className":"is-style-section-3","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","right":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|60"}}},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group is-style-section-3" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)">
				<!-- wp:group {"style":{"spacing":{"blockGap":"10px"}},"layout":{"type":"constrained"}} -->
				<div class="wp-block-group">
					<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5","textTransform":"uppercase","fontStyle":"normal","fontWeight":"400"}},"fontSize":"x-small"} -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group is-style-section-4" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)"><
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group" style="line-height:1">
						<!-- wp:image {"width":"20px","height":"20px","scale":"cover","sizeSlug":"large","linkDestination":"none","className":"is-style-display-block is-style-filter-invert"} -->
						<figure class="wp-block-image size-large is-resized is-style-display-block is-style-filter-invert"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/icons/icon-circle-check-dark.svg'; ?>" alt="Circle check light icon" style="object-fit:cover;width:20px;height:20px"/></figure>
						<!-- /wp:image -->
						<!-- wp:paragraph {"fontSize":"small"} -->
						<p class="has-small-font-size"><?php echo esc_html__( 'Powder theme', 'powder' ); ?></p>
						<!-- /wp:paragraph -->
