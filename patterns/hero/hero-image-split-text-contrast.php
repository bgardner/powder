...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color" style="margin-top:0;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<div class="wp-block-group alignwide">
		<!-- wp:paragraph {"className":"is-style-eyebrow","style":{"typography":{"textAlign":"center"}}} -->
		<p class="has-text-align-center is-style-eyebrow"><?php echo esc_html__( 'Designed by Brian Gardner', 'powder' ); ?></p>
		<!-- /wp:paragraph -->
		...
		<div class="wp-block-columns">
			...
			<div class="wp-block-column">
				...
				<p class="has-small-font-size"><?php echo esc_html__( 'Rooted in simplicity and built with purpose, Powder brings an abundance of patterns, versatile templates, and tailored color palette to designers and agencies.', 'powder' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
			<!-- wp:column -->
