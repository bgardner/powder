 ...
 * Slug: powder/hero-cover-stack-primary
 * Categories: powder-hero
 */
?>
<!-- wp:cover {"metadata":{"name":"Hero Cover"},"overlayColor":"primary","isUserOverlayColor":true,"minHeight":600,"align":"full","style":{"spacing":{"blockGap":"10px","margin":{"top":"0"}}},"textColor":"base","layout":{"type":"constrained","wideSize":"1280px"}} -->
<div class="wp-block-cover alignfull has-base-color has-text-color" style="margin-top:0;min-height:600px"><span aria-hidden="true" class="wp-block-cover__background has-primary-background-color has-background-dim-100 has-background-dim"></span><div class="wp-block-cover__inner-container">
