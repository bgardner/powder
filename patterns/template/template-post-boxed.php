...
<main class="wp-block-group" style="margin-top:0">
	...
	<article class="wp-block-group">
		<!-- wp:cover {"useFeaturedImage":true,"overlayColor":"contrast","isUserOverlayColor":true,"minHeight":400,"sizeSlug":"full","className":"is-style-gradient","style":{"spacing":{"padding":{"bottom":"140px"},"blockGap":"0"},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"textColor":"base","layout":{"type":"default"}} -->
		...
		<div class="wp-block-group" style="margin-top:0px">
			<!-- wp:group {"className":"is-style-position-relative is-style-positive-zindex","style":{"spacing":{"margin":{"top":"-100px"},"blockGap":"0"},"shadow":"var:preset|shadow|light"},"backgroundColor":"white","layout":{"type":"default"}} -->
			<div class="wp-block-group is-style-position-relative is-style-positive-zindex has-white-background-color has-background" style="margin-top:-100px;box-shadow:var(--wp--preset--shadow--light)">
				<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}}},"backgroundColor":"white","layout":{"type":"constrained"}} -->
				<div class="wp-block-group has-white-background-color has-background" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--40)">
