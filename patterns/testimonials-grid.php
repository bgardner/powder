	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-group">
				...
				<figure class="wp-block-image aligncenter size-full is-resized is-style-rounded"><img src="https://powderwp.com/studio/wp-content/themes/powder-studio/assets/images/sample-avatar-dark.svg" alt="Sample avatar" style="object-fit:cover;width:40px;height:40px"/></figure>
				<!-- /wp:image -->
				<!-- wp:paragraph {"fontSize":"small"} -->
