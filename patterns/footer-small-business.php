...
<div class="wp-block-group alignfull" style="margin-top:0px;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<div class="wp-block-columns alignwide" style="margin-top:var(--wp--preset--spacing--large)">
		...
		<div class="wp-block-column" style="flex-basis:40%">
			<!-- wp:heading {"level":3,"style":{"typography":{"textTransform":"uppercase"},"color":{"text":"#525252"}},"fontSize":"x-small"} -->
			<h3 class="wp-block-heading has-text-color has-x-small-font-size" style="color:#525252;text-transform:uppercase"><?php echo esc_html__( 'Main Office', 'powder' ); ?></h3>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column" style="flex-basis:60%">
			...
			<div class="wp-block-columns">
				...
				<div class="wp-block-column">
					<!-- wp:heading {"level":3,"style":{"typography":{"textTransform":"uppercase"},"color":{"text":"#525252"}},"fontSize":"x-small"} -->
					<h3 class="wp-block-heading has-text-color has-x-small-font-size" style="color:#525252;text-transform:uppercase">Chicago</h3>
					<!-- /wp:heading -->
					<!-- wp:list {"style":{"typography":{"lineHeight":"1.5"}},"className":"is-style-no-style","fontSize":"small"} -->
					<ul style="line-height:1.5" class="is-style-no-style has-small-font-size">
						<!-- wp:list-item -->
				...
				<div class="wp-block-column">
					<!-- wp:heading {"level":3,"style":{"typography":{"textTransform":"uppercase"},"color":{"text":"#525252"}},"fontSize":"x-small"} -->
					<h3 class="wp-block-heading has-text-color has-x-small-font-size" style="color:#525252;text-transform:uppercase">Nashville</h3>
					<!-- /wp:heading -->
					<!-- wp:list {"style":{"typography":{"lineHeight":"1.5"}},"className":"is-style-no-style","fontSize":"small"} -->
					<ul style="line-height:1.5" class="is-style-no-style has-small-font-size">
						<!-- wp:list-item -->
				...
				<div class="wp-block-column">
					<!-- wp:heading {"level":3,"style":{"typography":{"textTransform":"uppercase"},"color":{"text":"#525252"}},"fontSize":"x-small"} -->
					<h3 class="wp-block-heading has-text-color has-x-small-font-size" style="color:#525252;text-transform:uppercase">New York</h3>
					<!-- /wp:heading -->
					<!-- wp:list {"style":{"typography":{"lineHeight":"1.5"}},"className":"is-style-no-style","fontSize":"small"} -->
					<ul style="line-height:1.5" class="is-style-no-style has-small-font-size">
						<!-- wp:list-item -->
