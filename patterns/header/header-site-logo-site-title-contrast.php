<?php
/**
 * Title: Header - site logo, site title
 * Slug: powder/header-site-logo-site-title-contrast
...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color" style="margin-top:0px;padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)">
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group">
			...
			<!-- wp:group {"style":{"border":{"left":{"width":"1px","style":"dotted"}},"spacing":{"padding":{"left":"12px"}}},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group" style="border-left-style:dotted;border-left-width:1px;padding-left:12px">
