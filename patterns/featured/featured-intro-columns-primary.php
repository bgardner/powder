 ...
 * Slug: powder/featured-intro-columns-primary
 * Categories: powder-featured
 */
?>
<!-- wp:group {"metadata":{"name":"Featured Intro"},"align":"full","style":{"spacing":{"margin":{"top":"0"},"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"backgroundColor":"primary","textColor":"base","layout":{"type":"constrained"}} -->
